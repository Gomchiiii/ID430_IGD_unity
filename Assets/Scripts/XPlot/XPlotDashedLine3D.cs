...
namespace XPlot {
    public class XPlotDashedLine3D : XAppLine3D {
        // constants
        ...
        // constructor
        public XPlotDashedLine3D(string name, Vector3 start, Vector3 end,
        ...
        protected override void refreshRenderer() {
            ...
            float lineLength = Vector3.Distance(line.getPt0(), line.getPt1());
